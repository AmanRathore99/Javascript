...
CREATE TABLE `orders` (
  `orderRowId` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_customerRowId_in_customer_table` (`customerRowId`),
...
INSERT INTO `orders` VALUES (1,'Ord-101','21/05/21','29/05/21','',1);
...
-- Dump completed on 2021-05-22 15:22:30
