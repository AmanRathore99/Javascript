...
CREATE TABLE `vendor` (
  `vendorRowId` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `vendor` VALUES (1,'v-101','Ankit',887888,'Indore');
...
-- Dump completed on 2021-05-22 15:22:33
