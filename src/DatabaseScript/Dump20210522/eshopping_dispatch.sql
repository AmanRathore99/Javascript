...
CREATE TABLE `dispatch` (
  `dispatchRowId` int NOT NULL AUTO_INCREMENT,
  `dispatchId` varchar(30) DEFAULT NULL,
  `dispatchDate` varchar(30) DEFAULT NULL,
  `tracking` varchar(30) DEFAULT NULL,
  `orderRowId` int NOT NULL,
  `productRowId` int NOT NULL,
  PRIMARY KEY (`dispatchRowId`),
  UNIQUE KEY `dispatchId` (`dispatchId`),
  KEY `fk_orderRowId_in_dispatch_table` (`orderRowId`),
  KEY `fk_productRowId_in_product_table` (`productRowId`),
...
-- Dump completed on 2021-05-22 15:22:42
